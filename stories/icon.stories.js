...
export const feather = () => {
  ...
  ~style: option(ReactDomRe.Style.t),
                ...
                <p>
                    ...
                    'react-icons', and generates ReasonML type bindings for
                    them. We are currently using all 'feather-icons' from the
                    'react-icons' library. The cool part is that even though the
                    file with the bindings is huge, it will be removed at
                    compile time since they're simply type bindings. Check out
                    the icons below.
                </p>
                ...
                {filteredIcons.map(({ name, component }) => (
                    <div key={name} style={icon.container}>
